		...
		["RingKeeper"] = {
			["Mounts1"] = {
				...
				}, -- [7]
				{
					"mount", -- [1]
					1285, -- [2]
					["sliceToken"] = "ABuek38vKWp",
				}, -- [8]
				{
					"mount", -- [1]
					1040, -- [2]
					["sliceToken"] = "ABuek38vKWo",
				}, -- [9]
				{
					"mount", -- [1]
					1044, -- [2]
					["sliceToken"] = "ABuek38vKW2",
				}, -- [10]
				{
					"mount", -- [1]
					1239, -- [2]
					["sliceToken"] = "ABuek38vKWi",
				}, -- [11]
				["name"] = "Mounts",
				["save"] = true,
			},
			...
			["eportation"] = {
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:3561}}; [nomod] {{spell:3567}}; [mod:ctrl] {{spell:10059}}; [mod:ctrl] {{spell:11417}}",
					["sliceToken"] = "ABuekyM7s9d",
				}, -- [1]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:3562}}; [nomod] {{spell:3566}}; [mod:ctrl] {{spell:11416}}; [mod:ctrl] {{spell:11420}}",
					["sliceToken"] = "ABuekyM7s93",
				}, -- [2]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:3565}}; [nomod] {{spell:3563}}; [mod:ctrl] {{spell:11419}}; [mod:ctrl] {{spell:11418}}",
					["sliceToken"] = "ABuekyM7s9s",
				}, -- [3]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:32271}}; [nomod] {{spell:32272}}; [mod:ctrl] {{spell:32266}}; [mod:ctrl] {{spell:32267}}",
					["sliceToken"] = "ABuekyM7s9a",
				}, -- [4]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:49359}}; [nomod] {{spell:49358}}; [mod:ctrl] {{spell:49361}}; [mod:ctrl] {{spell:49360}}",
					["sliceToken"] = "ABuekyM7s9p",
				}, -- [5]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:120145}}; [mod:ctrl] {{spell:120146}}",
					["sliceToken"] = "ABuekyM7s9o",
				}, -- [6]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:33690}}; [mod:ctrl] {{spell:33691}}",
					["sliceToken"] = "ABuekyM7s92",
				}, -- [7]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:53140}}; [mod:ctrl] {{spell:53142}}",
					["sliceToken"] = "ABuekyM7s9i",
				}, -- [8]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:88342}}; [mod:ctrl] {{spell:88345}}",
					["sliceToken"] = "ABuekyM7s9u",
				}, -- [9]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:132621}}; [mod:ctrl] {{spell:132620}}",
					["sliceToken"] = "ABuekyM7s9y",
				}, -- [10]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:176248}}; [nomod] {{spell:176242}}; [mod:ctrl] {{spell:176244}}; [mod:ctrl] {{spell:176246}}",
					["sliceToken"] = "ABuekyM7s9t",
				}, -- [11]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:224869}}; [mod:ctrl] {{spell:224871}}",
					["sliceToken"] = "ABuekyM7s91",
				}, -- [12]
				{
					["id"] = 193759,
					["sliceToken"] = "ABuekyM7s9r",
				}, -- [13]
				{
					["id"] = "#showtooltip\n/cast [nomod] {{spell:281403}}; [nomod] {{spell:281404}}; [mod:ctrl] {{spell:281402}}; [mod:ctrl] {{spell:281400}}",
			...
			["x"] = {
				{
					["id"] = 315584,
					["sliceToken"] = "ABuekccwjyu",
				}, -- [1]
				{
					["id"] = 3408,
					["sliceToken"] = "ABuekccwjyy",
				}, -- [2]
				{
					["id"] = 8679,
					["sliceToken"] = "ABuekccwjyt",
				}, -- [3]
				["name"] = "Яды",
				["save"] = true,
				["hotkey"] = "ALT-NUMPADMINUS",
				["limit"] = "Ворбелья-Ревущийфьорд",
			},
			["onsumables"] = {
				{
					"item", -- [1]
